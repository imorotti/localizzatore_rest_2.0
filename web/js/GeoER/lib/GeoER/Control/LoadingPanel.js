 ...
 *
 * Class: GeoER.Control.LoadingPanel
 ...
 *  - <OpenLayers.Control>
 */
GeoER.Control.LoadingPanel = GeoER.Class(OpenLayers.Control, {
    ...
    */
    ...
    /**
     * Constructor: GeoER.Control.LoadingPanel
    ...
    */
    ...
    draw: function () {
        ...
        divcontent.style.width = '100px';
        divcontent.style.opacity = '0.8';
        divcontent.style.margin = 'auto';
        divcontent.style.padding = '4px';
        divcontent.style.backgroundColor = '#FFFFFF';
        var img = document.createElement("img");
        img.src = GeoER.Util.getImagesLocation() + "loadingmap.gif";
        ...
        span.appendChild(document.createTextNode(GeoER.i18n('loadingPanelLabel')));
    ...
    CLASS_NAME: "GeoER.Control.LoadingPanel"
