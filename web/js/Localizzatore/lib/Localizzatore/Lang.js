...
Localizzatore.Lang = {
     ...
     */
    getCode: function() {
        if(!Localizzatore.Lang.code) {
        	Localizzatore.Lang.setCode();
        }
        return Localizzatore.Lang.code;
    },
    ...
    setCode: function(code) {
        ...
        if(typeof Localizzatore.Lang[parts[0]] == "object") {
            lang = parts[0];
        }
        ...
        if(parts[1]) {
            ...
            if(typeof Localizzatore.Lang[testLang] == "object") {
                lang = testLang;
            }
        }
        if(!lang) {
    ...
    translate: function(key, context) {
        var dictionary = Localizzatore.Lang[Localizzatore.Lang.getCode()];
