...
public class AbacoSDA extends SHPObject {
    ...
    /// <param name="nparti">numero di parti di cui è composta la geometria</param>
    ...
    public byte[] getSDABytes() {
        //array di byte della lunghezza dell'oggetto SDA che corrisponderà
        //al formato binario SDA e che verrà restituito dalla funzione
    ...
    /// controllando se la lunghezza in byte è uguale a 0,
    /// se l'array delle parti è nullo e
