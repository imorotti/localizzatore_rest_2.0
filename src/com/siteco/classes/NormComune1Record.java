...
public class NormComune1Record {
   ...
   /**
    * Gets the CAP value for this Norm_Comune1OutputRecordset.
    *
    * @return CAP
    */
   ...
   /**
    * Sets the CAP value for this Norm_Comune1OutputRecordset.
    *
    * @param CAP
    */
   ...
   /**
    * Gets the COD_CAT value for this Norm_Comune1OutputRecordset.
    *
    * @return COD_CAT
    */
   @XmlElement(namespace="http://www.sitecoinf.it/values")
   ...
   /**
    * Sets the COD_CAT value for this Norm_Comune1OutputRecordset.
    *
    * @param COD_CAT
    */
   ...
   /**
    * Gets the COD_ISTAT value for this Norm_Comune1OutputRecordset.
    *
    * @return COD_ISTAT
    */
   @XmlElement(namespace="http://www.sitecoinf.it/values")
   ...
   /**
    * Sets the COD_ISTAT value for this Norm_Comune1OutputRecordset.
    *
    * @param COD_ISTAT
    */
   ...
   /**
    * Gets the COD_NAZIONALE value for this Norm_Comune1OutputRecordset.
    *
   ...
   /**
    * Sets the COD_NAZIONALE value for this Norm_Comune1OutputRecordset.
    *
    * @param COD_NAZIONALE
    */
   ...
   /**
    * Gets the COMUNE_ID value for this Norm_Comune1OutputRecordset.
    *
    * @return COMUNE_ID
    */
   @XmlElement(namespace="http://www.sitecoinf.it/values")
   ...
   /**
    * Sets the COMUNE_ID value for this Norm_Comune1OutputRecordset.
    *
    * @param COMUNE_ID
    */
   ...
   /**
    * Gets the DENOMINAZIONE value for this Norm_Comune1OutputRecordset.
    *
   ...
   /**
    * Sets the DENOMINAZIONE value for this Norm_Comune1OutputRecordset.
    *
    * @param DENOMINAZIONE
    */
   ...
   /**
    * Gets the FLG_CESSATO value for this Norm_Comune1OutputRecordset.
    *
    * @return FLG_CESSATO
    */
   @XmlElement(namespace="http://www.sitecoinf.it/values")
   ...
   /**
    * Sets the FLG_CESSATO value for this Norm_Comune1OutputRecordset.
    *
    * @param FLG_CESSATO
    */
   ...
   /**
    * Gets the GR_AFFIDABILITA value for this Norm_Comune1OutputRecordset.
    *
   ...
   /**
    * Sets the GR_AFFIDABILITA value for this Norm_Comune1OutputRecordset.
    *
   ...
   /**
    * Gets the NUMERO_RIGA value for this Norm_Comune1OutputRecordset.
    *
    * @return NUMERO_RIGA
    */
   @XmlElement(namespace="http://www.sitecoinf.it/values")
   ...
   /**
    * Sets the NUMERO_RIGA value for this Norm_Comune1OutputRecordset.
    *
    * @param NUMERO_RIGA
    */
   ...
   /**
    * Gets the NUMERO_RIGHE value for this Norm_Comune1OutputRecordset.
    *
    * @return NUMERO_RIGHE
    */
   @XmlElement(namespace="http://www.sitecoinf.it/values")
   ...
   /**
    * Sets the NUMERO_RIGHE value for this Norm_Comune1OutputRecordset.
    *
    * @param NUMERO_RIGHE
    */
